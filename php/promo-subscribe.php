...
$api_key = "a6e95267d881bae8bdf612971af3ea76-us14"; // YOUR-API-KEY-HERE
$list_id = "204f1767c0"; // YOUR-LIST-ID-HERE
...
try {
	$result = $MailChimp->call('lists/subscribe', array(
	    ...
	    'merge_vars'        => array('FNAME' => $_POST['fname'], 'ZIP' => $_POST['zip'], 'MESSAGE' => $_POST['message']),
	    'double_optin'      => false,
