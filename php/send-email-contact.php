<?php
	// Your Email
	$recipient = "info@zebra-fuel.com"; // PLEASE SET THE EMAIL ADDRESS of recipient
	$recipient_name = "Zebra INFO"; // PLEASE SET THE NAME OF the email address holder
	$subject_title = "A new email from zebra-fuel.com contact form"; //
